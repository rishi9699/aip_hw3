function res = mtimes(A,x)
	...
	radon_transforms = reshape(x(11341:3*5670), 315, 18);
	res3 = iradon(radon_transforms, A.angles3, 220); %check output size
	res3 = reshape(dct2(res3), [], 1); %Check reshape
	
	res = [res1; (res2 - res1); (res3 - res1)]; 
end
